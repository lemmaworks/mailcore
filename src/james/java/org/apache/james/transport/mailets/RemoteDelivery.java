...
public class RemoteDelivery extends GenericMailet implements Runnable {
        ...
        try {
            ...
            while ( targetServers.hasNext()) {
                try {
                    ...
                    log(logMessageBuffer.toString());
                    return true;
                } catch (SendFailedException sfe) { //SendFailedException is an inherited class of MessagingException

                    /**
                     * Assumptions:
                     *      1. Invalid addresses and thus cannot be sent
                     *      2. Valid addresses but cannot be sent
                     *      3. Valid addresses and sent, but there exist at least one address of the 2
                     *         reasons above
                     */
                    ...
                    if (sfe.getValidUnsentAddresses() != null
                        ...
                        // There are no valid addresses left to send, so rethrow, !!!THROW HERE!!!
                        //At this place means all valid addresses have been sent, and there are
    ...
    public void run() {
        ...
        //!IMPORTANT the HELLO_NAME is configured in config.xml -> smtpserver -> handler -> helloName
        //By convention, the HELLO_NAME is the domain name of the server, if you make it wrong the
        //target server may reject to HELO you.
        //There is also a possibility that they will let you pass the 1st time, after that, some
        //"human computer" will manually remove you from whitelist.
